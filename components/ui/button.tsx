...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'border border-foreground bg-transparent text-foreground hover:bg-hover hover:text-hover-foreground hover:border-hover',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-foreground/30 bg-transparent text-foreground hover:border-hover hover:bg-hover hover:text-hover-foreground',
        secondary:
          'bg-foreground text-background hover:bg-hover hover:text-hover-foreground',
