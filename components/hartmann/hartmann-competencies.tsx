      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {competencies.map((comp) => (
            <div key={comp.id} className="group overflow-hidden rounded-sm bg-white shadow-sm transition-shadow hover:shadow-md">
              <div className="relative aspect-[4/3] overflow-hidden">
                <Image src={comp.imageUrl} alt={comp.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" />
              </div>
              <div className="p-5">
