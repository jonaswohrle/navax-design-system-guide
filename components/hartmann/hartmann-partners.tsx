  ...
  return (
    <section className="bg-white py-12 lg:py-16">
      <div className="mx-auto max-w-[1200px] px-6">
        <h2 className="mb-8 text-center text-[22px] font-bold text-foreground lg:text-[28px]">
        ...
        <div className="flex flex-wrap justify-center gap-2.5">
          {categories.map((cat) => (
            <button
              key={cat.id}
              className="rounded-full bg-primary px-5 py-2 text-[12px] font-medium text-white transition-colors hover:bg-hover"
            >
              {cat.name}
            </button>
          ))}
